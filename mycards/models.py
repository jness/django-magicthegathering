...
class Prices(models.Model):
    ...
    name = models.CharField(max_length=50)
    mtgset = models.CharField(max_length=75)
    price_high = models.DecimalField(max_digits=11, decimal_places=2)
    price_med = models.DecimalField(max_digits=11, decimal_places=2)
    price_low = models.DecimalField(max_digits=11, decimal_places=2)
